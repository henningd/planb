...
class CompanyObserver
{
    ...
    /**
     * Default scenarios seeded per company. Each includes concrete steps that a KMU
     * can realistically follow in an incident.
     *
     ...
     */
    protected const DEFAULT_SCENARIOS = [
        [
    ...
    /**
     * Seed default emergency levels, system priorities and scenario playbooks
    ...
    public function created(Company $company): void
    {
        ...
        foreach (self::DEFAULT_SCENARIOS as $scenarioData) {
            ...
            foreach ($scenarioData['steps'] as $index => $step) {
