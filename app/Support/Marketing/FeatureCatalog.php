        ...
        return [
            'compliance-dashboard' => [
                ...
                'screenshots' => [
                    ...
                    ['file' => 'compliance-trend.png', 'caption' => '30-Tage-Verlauf des Compliance-Scores für den Mandanten Musterfirma GmbH.'],
                ],
                'demo_hint' => 'Im Demo-Account (Musterfirma GmbH) sind 31 tägliche Snapshots vorbefüllt — du siehst sofort einen realistischen Trend.',
            ...
            'risiko-register' => [
                ...
                'screenshots' => [
                    ['file' => 'risks-heatmap.png', 'caption' => '5×5-Heatmap mit den sechs Demo-Risiken über alle Severity-Level verteilt.'],
                    ['file' => 'risks-detail.png', 'caption' => 'Detail-Ansicht „Ransomware-Befall des Datei-Servers" mit drei Maßnahmen und verknüpften Systemen.'],
                ],
                'demo_hint' => 'Im Demo-Account sind sechs Risiken vorbefüllt: ein kritisches (Ransomware), drei hohe (Stromausfall, Handwerkersoftware-Ausfall, IT-Dienstleister), zwei mittlere — alle mit echten System-Verknüpfungen.',
            ...
            'lessons-learned' => [
                ...
                'screenshots' => [
                    ['file' => 'lessons-list.png', 'caption' => 'Übersicht der drei Demo-Auswertungen mit Bezug auf Übung, Vorfall und Versionsstand.'],
                    ['file' => 'lessons-detail.png', 'caption' => 'Detail-Ansicht mit Ursachenanalyse und Action-Items in unterschiedlichen Status.'],
                ],
                'demo_hint' => 'Drei Lessons Learned sind im Demo-Account vorbereitet: Tabletop-Ransomware mit langsamer Eskalation, Phishing-Welle Buchhaltung, Stromausfall-Übung mit zu schwacher USV.',
            ...
            'war-room' => [
                ...
                'screenshots' => [
                    ['file' => 'war-room.png', 'caption' => 'Run-Detail mit Anwesenheits-Banner und Live-Step-Liste — drei Personen gleichzeitig auf der Lage.'],
                ],
                'demo_hint' => 'Den War-Room siehst du, sobald du einen aktiven Scenario-Run im Demo-Account startest und in einem zweiten Browser-Tab als anderer Nutzer auf denselben Run gehst.',
            ...
            'audit-export' => [
                ...
                'screenshots' => [
                    ['file' => 'audit-log.png', 'caption' => 'Audit-Log mit Datumsfilter und Aktions-Filter, Demo-Mandant mit über 175 Einträgen.'],
                    ['file' => 'audit-export-zip.png', 'caption' => '„Vollständiges Archiv (ZIP)"-Knopf in den System-Settings — ein Klick = DSGVO-Auskunft.'],
                ],
                'demo_hint' => 'Der Demo-Mandant hat über 175 Audit-Einträge angesammelt — gut genug, um die Filter, den CSV/PDF-Export und das ZIP zu testen.',
            ...
            'monitoring' => [
                ...
                'demo_hint' => 'Im Demo-Account sind sieben Beispiel-Alerts aus Zabbix und Prometheus eingegangen — über alle fünf Verarbeitungspfade verteilt (Incident erstellt, Folge-Alert, Severity zu niedrig, kein System gemappt, ignoriert).',
