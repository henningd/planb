...
test('a verified user without two-factor is forced to set it up when enforcement is on', function () {
...
test('a verified user with confirmed two-factor is not redirected', function () {
    config(['features.enforce_two_factor' => true]);
